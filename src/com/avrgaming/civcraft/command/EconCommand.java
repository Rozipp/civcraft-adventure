...
public class EconCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("add", CivSettings.localize.localizedString("cmd_econ_addDesc"));
		cs.add("give", CivSettings.localize.localizedString("cmd_econ_giveDesc"));
		cs.add("set", CivSettings.localize.localizedString("cmd_econ_setDesc"));
		cs.add("sub",CivSettings.localize.localizedString("cmd_econ_subDesc"));
		
		cs.add("addtown", CivSettings.localize.localizedString("cmd_econ_addtownDesc"));
		cs.add("settown", CivSettings.localize.localizedString("cmd_econ_settownDesc"));
		cs.add("subtown", CivSettings.localize.localizedString("cmd_econ_subtownDesc"));
		
		cs.add("addciv", CivSettings.localize.localizedString("cmd_econ_addcivDesc"));
		cs.add("setciv", CivSettings.localize.localizedString("cmd_econ_setcivDesc"));
		cs.add("subciv", CivSettings.localize.localizedString("cmd_econ_subcivDesc"));
		
		cs.add("setdebt", CivSettings.localize.localizedString("cmd_econ_setdebtDesc"));
		cs.add("setdebttown", CivSettings.localize.localizedString("cmd_econ_setdebttownDesc"));
		cs.add("setdebtciv", CivSettings.localize.localizedString("cmd_econ_setdebtcivDesc"));
		
		cs.add("clearalldebt", CivSettings.localize.localizedString("cmd_econ_clearAllDebtDesc"));
