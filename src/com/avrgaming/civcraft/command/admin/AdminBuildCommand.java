...
public class AdminBuildCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("unbuild", CivSettings.localize.localizedString("adcmd_build_unbuildDesc"));
		cs.add("demolish", CivSettings.localize.localizedString("adcmd_build_demolishDesc"));
		cs.add("repair", CivSettings.localize.localizedString("adcmd_build_repairDesc"));
...
//		cs.add("changenearest", CivSettings.localize.localizedString("adcmd_build_changeNearestDesc"));
		...
		cs.add("listinvalid", CivSettings.localize.localizedString("adcmd_build_listInvalidDesc"));
		cs.add("showbuildable", CivSettings.localize.localizedString("adcmd_build_showBuildableDesc"));
