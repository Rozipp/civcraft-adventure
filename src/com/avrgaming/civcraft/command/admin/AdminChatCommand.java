...
public class AdminChatCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("tc", CivSettings.localize.localizedString("adcmd_chat_tcDesc"));
		cs.add("cc", CivSettings.localize.localizedString("adcmd_chat_ccDesc"));
		cs.add("cclisten", CivSettings.localize.localizedString("adcmd_chat_cclisten"));
		cs.add("tclisten", CivSettings.localize.localizedString("adcmd_chat_tclisten"));
		cs.add("listenoff", CivSettings.localize.localizedString("adcmd_chat_listenOffDesc"));
		cs.add("cclistenall", CivSettings.localize.localizedString("adcmd_chat_listenAllDesc"));
		cs.add("tclistenall", CivSettings.localize.localizedString("adcmd_chat_tclistenAllDesc"));
		cs.add("banwordon", CivSettings.localize.localizedString("adcmd_chat_banWordOnDesc"));
		cs.add("banwordoff", CivSettings.localize.localizedString("adcmd_chat_banWordOffDesc"));
		cs.add("banwordadd", CivSettings.localize.localizedString("admcd_chat_banwordaddDesc"));
		cs.add("banwordremove", CivSettings.localize.localizedString("adcmd_chat_banwordremoveDesc"));
		cs.add("banwordtoggle", CivSettings.localize.localizedString("adcmd_chat_banwordToggleDesc"));
	...
	public void cclisten_cmd() throws CivException {
		if (args.length < 2) throw new CivException(CivSettings.localize.localizedString("EnterCivName"));
	...
	public void tclisten_cmd() throws CivException {
		if (args.length < 2) throw new CivException(CivSettings.localize.localizedString("EnterTownName"));
	...
	public void banwordadd_cmd() throws CivException {
		if (args.length < 2) throw new CivException(CivSettings.localize.localizedString("adcmd_chat_addBanwordPrompt"));
	...
	public void banwordremove_cmd() throws CivException {
		if (args.length < 2) throw new CivException(CivSettings.localize.localizedString("adcmd_chat_removeBanwordPrompt"));
