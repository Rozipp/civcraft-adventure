...
public class AdminCivCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("disband", CivSettings.localize.localizedString("adcmd_civ_disbandDesc"));
		cs.add("addleader", CivSettings.localize.localizedString("adcmd_civ_addLeaderDesc"));
		cs.add("addadviser", CivSettings.localize.localizedString("adcmd_civ_addAdvisorDesc"));
		cs.add("rmleader", CivSettings.localize.localizedString("adcmd_civ_rmLeaderDesc"));
		cs.add("rmadviser", CivSettings.localize.localizedString("adcmd_civ_rmAdvisorDesc"));
		cs.add("givetech", CivSettings.localize.localizedString("adcmd_civ_giveTechDesc"));
		cs.add("beakerrate", CivSettings.localize.localizedString("adcmd_civ_beakerRateDesc"));
		cs.add("toggleadminciv", CivSettings.localize.localizedString("adcmd_civ_toggleadminCivDesc"));
		cs.add("alltech", CivSettings.localize.localizedString("adcmd_civ_alltechDesc"));
		cs.add("setrelation", CivSettings.localize.localizedString("adcmd_civ_setRelationDesc"));
		cs.add("info", CivSettings.localize.localizedString("adcmd_civ_infoDesc"));
		cs.add("merge", CivSettings.localize.localizedString("adcmd_civ_mergeDesc"));
		cs.add("setgov", CivSettings.localize.localizedString("adcmd_civ_setgovDesc"));
		cs.add("bankrupt", CivSettings.localize.localizedString("adcmd_civ_bankruptDesc"));
		cs.add("conquered", CivSettings.localize.localizedString("adcmd_civ_concqueredDesc"));
		cs.add("unconquer", CivSettings.localize.localizedString("adcmd_civ_unconquerDesc"));
		cs.add("liberate", CivSettings.localize.localizedString("adcmd_civ_liberateDesc"));
		cs.add("setvotes", CivSettings.localize.localizedString("adcmd_civ_setvotesDesc"));
		cs.add("rename", CivSettings.localize.localizedString("adcmd_civ_renameDesc"));
	}
