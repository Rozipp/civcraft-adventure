...
extends CommandBase {
    ...
    public void init() {
        ...
        this.cs.add("buglist", CivSettings.localize.localizedString("adcmd_report_buglistDesc", Bukkit.getServer().getServerName()));
        this.cs.add("playerlist", CivSettings.localize.localizedString("adcmd_report_playerlistDesc", Bukkit.getServer().getServerName()));
        this.cs.add("close", CivSettings.localize.localizedString("adcmd_report_closelistDesc", Bukkit.getServer().getServerName()));
    }
