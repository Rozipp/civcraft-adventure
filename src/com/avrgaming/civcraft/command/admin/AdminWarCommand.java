...
public class AdminWarCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("start", CivSettings.localize.localizedString("adcmd_war_startDesc"));
		cs.add("stop", CivSettings.localize.localizedString("adcmd_war_stopDesc"));
		cs.add("resetstart", CivSettings.localize.localizedString("adcmd_war_resetstartDesc"));
		//cs.add("setlastwar", "takes a date of the form: DAY:MONTH:YEAR:HOUR:MIN (24 hour time)");
		cs.add("onlywarriors", CivSettings.localize.localizedString("adcmd_war_onlywarriorsDesc"));
	}
