...
public class CivDiplomacyCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("liberate", CivSettings.localize.localizedString("cmd_civ_dip_liberateDesc"));
		cs.add("capitulate", CivSettings.localize.localizedString("cmd_civ_dip_capitulateDesc"));
	}
