...
public class CivDiplomacyGiftCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("entireciv", CivSettings.localize.localizedString("cmd_civ_dipgift_entirecivDesc"));
		cs.add("town", CivSettings.localize.localizedString("cmd_civ_dipgift_townDesc"));
