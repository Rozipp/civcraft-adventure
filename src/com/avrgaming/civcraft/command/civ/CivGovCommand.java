...
public class CivGovCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("info", CivSettings.localize.localizedString("cmd_civ_gov_infoDesc"));
		cs.add("change", CivSettings.localize.localizedString("cmd_civ_gov_changeDesc"));
		cs.add("list", CivSettings.localize.localizedString("cmd_civ_gov_listDesc"));
	}
