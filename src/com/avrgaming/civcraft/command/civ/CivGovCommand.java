...
public class CivGovCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("info", "i", CivSettings.localize.localizedString("cmd_civ_gov_infoDesc"));
		cs.add("change", "c", CivSettings.localize.localizedString("cmd_civ_gov_changeDesc"));
		cs.add("list", "l", CivSettings.localize.localizedString("cmd_civ_gov_listDesc"));
	}
	...
	public void change_cmd() throws CivException {
		...
		if (!gov.isAvailable(civ)) {
			throw new CivException(
					CivSettings.localize.localizedString("var_cmd_civ_gov_changeNotHere", gov.displayName));
		}
	...
	public void list_cmd() throws CivException {
		...
		for (ConfigGovernment gov : govs) {
			if (gov == civ.getGovernment()) {
				CivMessage.send(sender, CivColor.Gold + gov.displayName + " " + "("
						+ CivSettings.localize.localizedString("currentGovernment") + ")");
			} else {
	...
	public void info_cmd() throws CivException {
		...
		CivMessage.sendHeading(sender,
				CivSettings.localize.localizedString("cmd_civ_gov_infoHading") + " " + civ.getGovernment().displayName);
		CivMessage.send(sender,
				CivColor.Green + CivSettings.localize.localizedString("cmd_civ_gov_infoTrade") + " "
		...
		CivMessage.send(sender,
				CivColor.Green + CivSettings.localize.localizedString("cmd_civ_gov_infoUpkeep") + " "
		...
		CivMessage.send(sender,
				CivColor.Green + CivSettings.localize.localizedString("cmd_civ_gov_infoHammer") + " "
		...
		CivMessage.send(sender,
				CivColor.Green + CivSettings.localize.localizedString("cmd_civ_gov_infoCulture") + " "
