...
public class CivSetCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("taxes", CivSettings.localize.localizedString("cmd_civ_set_taxesDesc"));
		cs.add("science", CivSettings.localize.localizedString("cmd_civ_set_scienceDesc"));
		cs.add("color", CivSettings.localize.localizedString("cmd_civ_set_colorDesc"));
