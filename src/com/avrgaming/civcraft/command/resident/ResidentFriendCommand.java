...
public class ResidentFriendCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("add", CivSettings.localize.localizedString("cmd_res_friend_addDesc"));
		cs.add("remove", CivSettings.localize.localizedString("cmd_res_friend_removeDesc"));
		cs.add("list", CivSettings.localize.localizedString("cmd_res_friend_listDesc"));
	}
