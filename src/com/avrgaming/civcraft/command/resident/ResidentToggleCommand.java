...
public class ResidentToggleCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("map", CivSettings.localize.localizedString("cmd_res_toggle_mapDesc"));
		cs.add("info", CivSettings.localize.localizedString("cmd_res_toggle_infoDesc"));
		cs.add("showtown", CivSettings.localize.localizedString("cmd_res_toggle_showtownDesc"));
		cs.add("showciv", CivSettings.localize.localizedString("cmd_res_toggle_showcivDesc"));
		cs.add("showscout", CivSettings.localize.localizedString("cmd_res_toggle_showscoutDesc"));
		cs.add("combatinfo", CivSettings.localize.localizedString("cmd_res_toggle_combatinfoDesc"));
		cs.add("itemdrops", CivSettings.localize.localizedString("cmd_res_toggle_itemdropsDesc"));
		cs.add("titles", CivSettings.localize.localizedString("cmd_res_toggle_titleAPIDesc"));
