...
public class TownEventCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("show", CivSettings.localize.localizedString("cmd_town_event_showDesc"));
		cs.add("activate", CivSettings.localize.localizedString("cmd_town_event_activateDesc"));
	}
