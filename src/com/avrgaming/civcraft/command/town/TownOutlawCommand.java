...
public class TownOutlawCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("add", CivSettings.localize.localizedString("cmd_town_outlaw_addDesc"));
		cs.add("remove", CivSettings.localize.localizedString("cmd_town_outlaw_removeDesc"));
		cs.add("list", CivSettings.localize.localizedString("cmd_town_outlaw_listDesc"));
		cs.add("addall",CivSettings.localize.localizedString("cmd_town_outlaw_addallDesc") );
		cs.add("removeall", CivSettings.localize.localizedString("cmd_town_outlaw_removeallDesc"));
		cs.add("addallciv", CivSettings.localize.localizedString("cmd_town_outlaw_addallcivDesc"));
		cs.add("removeallciv", CivSettings.localize.localizedString("cmd_town_outlaw_removeallcivDesc"));
	}
