...
public class TownResetCommand extends CommandBase {
	...
	public void init() {
		...
		cs.add("library", CivSettings.localize.localizedString("cmd_town_reset_libraryDesc"));
		cs.add("store", CivSettings.localize.localizedString("cmd_town_reset_storeDesc"));
	}
