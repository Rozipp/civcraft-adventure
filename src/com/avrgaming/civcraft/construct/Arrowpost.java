...
public class Arrowpost extends Construct {
	...
	public static ConfigBuildableInfo arrowpostInfo;
	public static int maxHitpoints;

	static {
		try {
			maxHitpoints = CivSettings.getInteger(CivSettings.warConfig, "cannon.hitpoints");
			String templateName = "arrowpost";
			arrowpostInfo = new ConfigBuildableInfo("c_arrowpost", "Arrowpost", false, templateName, false, maxHitpoints, 0);
	...
	public Arrowpost(Player player) {
		this.setSQLOwner(CivGlobal.getResident(player).getTown());
		setInfo(Arrowpost.arrowpostInfo);
	}
