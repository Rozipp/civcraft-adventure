...
public class EnchantmentVirtual extends Enchantment {
	...
	public EnchantmentVirtual(int id) {
		super(id);
		fix(this);
	}
	...
	public boolean canEnchantItem(ItemStack item) {
		...
		EnchantmentCustom ce = Enchantments.enchantmentList.get(this.getId());
	...
	public boolean conflictsWith(Enchantment other) {
		...
		EnchantmentCustom cethis = Enchantments.enchantmentList.get(this.getId());
		if (other == this) return true;

		if (cethis.group.equals("Default")) return false;

		EnchantmentCustom ceother = Enchantments.enchantmentList.get(other.getId());
