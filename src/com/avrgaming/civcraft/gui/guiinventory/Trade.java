...
public class Trade extends GuiInventory {
	...
	public Trade(Player player, String arg) throws CivException {
		...
		GuiItem signStack = GuiItems.newGuiItem(ItemManager.createItemStack(CivData.WOOL, (short) CivData.DATA_WOOL_WHITE, 1));
		this.addGuiItem(8, GuiItems.newGuiItem(ItemManager.createItemStack(CivData.WOOL, (short) CivData.DATA_WOOL_RED, 1))//
		...
		int start = 4 * 9;
		this.addGuiItem(start, GuiItems.newGuiItem()//
		...
		this.addGuiItem(start + 1, GuiItems.newGuiItem()//
		...
		this.addGuiItem(start + 7, GuiItems.newGuiItem()//
				.setTitle(CivSettings.CURRENCY_NAME + " " + CivSettings.localize.localizedString("resident_tradeOffered"))//
				.setMaterial(Material.NETHER_BRICK_ITEM)//
				.setLore(CivColor.Yellow + "0 " + CivSettings.CURRENCY_NAME));
		this.addGuiItem(start + 8, GuiItems.newGuiItem(ItemManager.createItemStack(CivData.WOOL, (short) CivData.DATA_WOOL_RED, 1))//
