...
public abstract class CustomMaterial {
	...
	/** Предмет (предметы) ложаться в инвентарь через протягиваение с зажатой кнопкой мыши. Обработать так же как и onInvItemDrop() */
	public abstract void onInvItemDrag(InventoryDragEvent event, Inventory toInv, ItemStack stack);
