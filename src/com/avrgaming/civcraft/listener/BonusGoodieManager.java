...
public class BonusGoodieManager implements Listener {
	...
	/* Keeps track of the location of bonus goodies through various events. Will also repo goodies back to the trade outposts if they get destroyed. */
	...
	public void OnItemHeldChange(PlayerItemHeldEvent event) {
		...
		CivMessage.send(event.getPlayer(),
				CivColor.Purple + CivSettings.localize.localizedString("bonusGoodie_heading") + " " + CivColor.Yellow + goodie.getDisplayName());
...
//TODO полезный код проверки сундука
	...
	public void OnPlayerInteractEntityEvent(PlayerInteractEntityEvent event) {
		...
		if (material != null) {
			if (material instanceof UnitCustomMaterial || material instanceof UnitMaterial) {
		...
		if (goodie == null) {
			...
			if (frameStore != null) {
				...
				if (frame.getItem() == null || ItemManager.getTypeId(frame.getItem()) == CivData.AIR) {
