...
implements GuiAction {
    ...
    public void performAction(InventoryClickEvent event, ItemStack stack) {
        ...
        ItemStack progress = LoreGuiItem.build("§b" + missionName, ItemManager.getMaterialId(Material.DIAMOND_SWORD), 0, "§6"+CivSettings.localize.localizedString("beakers")+" " + beakers + CivColor.Red + "(" + percentageCompleteBeakers + "%)", "§d"+ CivSettings.localize.localizedString("hammers")+" " + hammers + CivColor.Red + "(" + percentageCompleteHammers + "%)");
        guiInventory.setItem(0, progress);
        ItemStack backButton = LoreGuiItem.build(CivSettings.localize.localizedString("loreGui_recipes_back"), ItemManager.getMaterialId(Material.MAP), 0, CivSettings.localize.localizedString("loreGui_recipes_backMsg"));
