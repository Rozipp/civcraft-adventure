    ...
    public void performAction(InventoryClickEvent event, ItemStack stack) {
        ...
        CivSettings.wonders.values().stream().map(info -> {
            ...
            if (!res.getTown().hasTechnology(info.require_tech)) {
                ...
                is = LoreGuiItem.build(info.displayName, ItemManager.getMaterialId(Material.GOLD_INGOT), 0, "§b" + CivSettings.localize.localizedString("money_requ", cost), "§a" + CivSettings.localize.localizedString("hammers_requ", hammer_cost), "§d" + CivSettings.localize.localizedString("ppoints", info.points), CivColor.Red + CivSettings.localize.localizedString("req") + tech.name, "§3" + CivSettings.localize.localizedString("clicktoresearch"));
                ...
                is = LoreGuiItem.build(info.displayName, ItemManager.getMaterialId(Material.BLAZE_ROD), 0, "§b" + CivSettings.localize.localizedString("money_requ", cost), "§a" + CivSettings.localize.localizedString("hammers_requ", hammer_cost), "§d" + CivSettings.localize.localizedString("ppoints", info.points), CivColor.Red + CivSettings.localize.localizedString("req") + upgrade.name, "§3" + CivSettings.localize.localizedString("clicktoresearch"));
                ...
                is = LoreGuiItem.build(info.displayName, ItemManager.getMaterialId(Material.EMERALD), 0, "§b" + CivSettings.localize.localizedString("money_requ", cost), "§a" + CivSettings.localize.localizedString("hammers_requ", hammer_cost), "§d" + CivSettings.localize.localizedString("ppoints", info.points), CivColor.Red + CivSettings.localize.localizedString("requ") + structure.displayName, "§3" + CivSettings.localize.localizedString("clicktobuild"));
                ...
                is = LoreGuiItem.build(info.displayName, ItemManager.getMaterialId(Material.DIAMOND_SWORD), 0, "§b" + CivSettings.localize.localizedString("money_requ", cost), "§a" + CivSettings.localize.localizedString("hammers_requ", hammer_cost), "§d" + CivSettings.localize.localizedString("ppoints", info.points), "§c"+CivSettings.localize.localizedString("town_buildwonder_errorBuiltElsewhere"));
            } else {
                is = LoreGuiItem.build(info.displayName, ItemManager.getMaterialId(Material.DIAMOND_BLOCK), 0, "§6" + CivSettings.localize.localizedString("clicktobuild"), "§b" + CivSettings.localize.localizedString("money_requ", cost), "§a" + CivSettings.localize.localizedString("hammers_requ", hammer_cost), "§d" + CivSettings.localize.localizedString("ppoints", info.points));
                is = LoreGuiItem.setAction(is, "WonderGuiBuild");
