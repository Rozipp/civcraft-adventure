...
implements GuiAction {
    ...
    public void performAction(InventoryClickEvent event, ItemStack stack) {
        ...
        ItemStack progressButton = LoreGuiItem.build(CivSettings.localize.localizedString("bookReborn_civSpaceProgressHeading"), ItemManager.getMaterialId(Material.MAP), 0, "§6" + CivSettings.localize.localizedString("click_to_view"));
        progressButton = LoreGuiItem.setAction(progressButton, "BookCivSpaceProgress");
        guiInventory.setItem(0, progressButton);
        ItemStack endedMissionButton = LoreGuiItem.build(CivSettings.localize.localizedString("bookReborn_civSpaceEndedHeading"), ItemManager.getMaterialId(Material.MAP), 0, "§6" + CivSettings.localize.localizedString("click_to_view"));
        endedMissionButton = LoreGuiItem.setAction(endedMissionButton, "BookCivSpaceEnded");
        guiInventory.setItem(1, endedMissionButton);
        ItemStack futureMissionsButton = LoreGuiItem.build(CivSettings.localize.localizedString("bookReborn_civSpaceFutureHeading"), ItemManager.getMaterialId(Material.MAP), 0, "§6" + CivSettings.localize.localizedString("click_to_view"));
