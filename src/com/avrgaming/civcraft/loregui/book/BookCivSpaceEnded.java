...
implements GuiAction {
    ...
    public void performAction(InventoryClickEvent event, ItemStack stack) {
        ...
        for (int i = 1; i < ended; ++i) {
            ...
            ItemStack itemStack = LoreGuiItem.build("§a" + configSpaceMissions.name, ItemManager.getMaterialId(Material.STAINED_GLASS_PANE), CivCraft.civRandom.nextInt(15), "§6" + CivSettings.localize.localizedString("click_to_view"));
