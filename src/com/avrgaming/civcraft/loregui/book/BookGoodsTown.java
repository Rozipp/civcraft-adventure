...
implements GuiAction {
    ...
    public void performAction(InventoryClickEvent event, ItemStack stack) {
        ...
        if (!civ.GM.isLeader(resident) && !resident.getSelectedTown().GM.isMayor(resident)) {
        ...
        ItemStack backButton = LoreGuiItem.build(CivSettings.localize.localizedString("loreGui_recipes_back"), ItemManager.getMaterialId(Material.MAP), 0, CivSettings.localize.localizedString("var_virtualTG_backToMain"));
