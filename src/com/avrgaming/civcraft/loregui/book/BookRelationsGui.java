...
implements GuiAction {
    ...
    public void performAction(InventoryClickEvent event, ItemStack stack) {
        ...
        ItemStack relation = LoreGuiItem.build(CivColor.LightGreenBold + CivSettings.localize.localizedString("resident_relationsGui_ally"), ItemManager.getMaterialId(Material.EMERALD_BLOCK), 0, (Object)ChatColor.RESET + CivSettings.localize.localizedString("resident_relationsGui_allyInfo"), "§6§6" + CivSettings.localize.localizedString("bookReborn_clickToView"));
