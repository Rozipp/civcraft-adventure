...
implements GuiAction {
    ...
    public void performAction(InventoryClickEvent event, ItemStack stack) {
        ...
        for (ConfigBuildableInfo info : CivSettings.structures.values()) {
            ...
            if (town.getMayorGroup() == null || town.getAssistantGroup() == null || civ.getLeaderGroup() == null) {
                ...
                if (str != null) {
                    ...
                    itemStack = LoreGuiItem.build(info.displayName, ItemManager.getMaterialId(Material.BEDROCK), 0, "§b" + CivSettings.localize.localizedString("money_requ", Double.parseDouble(String.valueOf(info.cost))), "§a" + CivSettings.localize.localizedString("hammers_requ", hammerCost), "§d" + CivSettings.localize.localizedString("upkeep_day", info.upkeep), CivColor.Red + CivSettings.localize.localizedString("requ") + str.displayName, "§3" + CivSettings.localize.localizedString("clicktobuild"));
        ...
        ItemStack wonderButton = LoreGuiItem.build(CivSettings.localize.localizedString("4udesa"), ItemManager.getMaterialId(Material.DIAMOND_BLOCK), 0, "§6" + CivSettings.localize.localizedString("click_to_view"));
