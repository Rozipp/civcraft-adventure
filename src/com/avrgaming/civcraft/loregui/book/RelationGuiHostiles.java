...
public class RelationGuiHostiles implements GuiItemAction {
	@Override
	public void performAction(InventoryClickEvent event, ItemStack stack) {
		...
		GuiInventory inventory = new GuiInventory(event.getWhoClicked(), CivSettings.localize.localizedString("resident_relationsGui_hostile"), BookRelationsGui.inventory.getName());
