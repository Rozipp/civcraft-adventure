...
public class CivSpaceComponentsNormal implements GuiItemAction {
	...
	public void performAction(InventoryClickEvent event, ItemStack stack) {
		...
		GuiInventory guiInventory = new GuiInventory(player, 1, CivSettings.localize.localizedString("bookReborn_civSpaceComponentsHeading"), CivSpaceEnded.guiInventory.getName());
		...
		guiInventory.addBackItem(CivSettings.localize.localizedString("loreGui_recipes_back"),
				CivSettings.localize.localizedString("loregui_backto") + " " + backTo);
