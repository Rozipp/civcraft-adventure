...
public class Tutorial extends GuiInventory {
	...
	public Tutorial(Player player, String arg) {
		...
		this.addGuiItem(10, GuiItems.newGuiItem()//
				.setMaterial(Material.BOOK_AND_QUILL)//
		...
		this.addGuiItem(11, GuiItems.newGuiItem()//
				.setMaterial(Material.WORKBENCH)//
		...
		this.addGuiItem(19, GuiItems.newGuiItem(Recipe.getInfoBookForItem("mat_found_civ"))//
				.setOpenInventory("Recipe", "mat_found_civ"));
		this.addGuiItem(18, GuiItems.newGuiItem(Recipe.getInfoBookForItem("mat_found_camp"))//
				.setOpenInventory("Recipe", "mat_found_camp"));
