...
public class Wonders extends GuiInventory {
	...
	public Wonders(Player player, String arg) {
		super(player, arg);
		...
		for (ConfigBuildableInfo info : CivSettings.wonders.values()) {
			...
			this.addGuiItem(GuiItems.newGuiItem()//
					...
					.setCallbackGui(info.displayName));
			continue;
		}
	}
	...
	public void execute(String... strings) {
		String toBuildStart = "build " + strings[0];
		Bukkit.dispatchCommand(getPlayer(), toBuildStart);
	}
