...
public class LoreGuiItem {
	...
	public static boolean isGUIItem(ItemStack stack) {
		String title = ItemManager.getProperty(stack, "GUI");
		return title != null;
	}
	...
	public static String getAction(ItemStack stack) {
		String action = ItemManager.getProperty(stack, "GUI_ACTION");
		return action;
	}
	...
	public static String getActionData(ItemStack stack, String key) {
		String data = ItemManager.getProperty(stack, "GUI_ACTION_DATA:" + key);
		return data;
	}
