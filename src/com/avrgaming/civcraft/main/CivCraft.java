...
//		CivPoint.init();
		...
		try {
			...
			SQL.initialize();
			if (CivSettings.getStringBase("clears_table_data").equalsIgnoreCase("true")) {
...
//				SQL.deleteTable(MobSpawner_FURNEX.TABLE_NAME);
...
//				SQL.deleteTable(StructureSign.TABLE_NAME);
