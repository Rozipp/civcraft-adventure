...
public class CivGlobal {
	...
	private static Map<Integer, Town> towns = new ConcurrentHashMap<Integer, Town>();
	private static Map<Integer, Civilization> civs = new ConcurrentHashMap<Integer, Civilization>();
