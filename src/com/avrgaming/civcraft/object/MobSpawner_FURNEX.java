...
public class MobSpawner_FURNEX extends SQLObject {
    ...
    public MobSpawner_FURNEX(ConfigMobSpawner spawner, BlockCoord coord) {
    ...
    public MobSpawner_FURNEX(ResultSet rs) throws SQLException, InvalidNameException {
        this.load(rs);
    }
