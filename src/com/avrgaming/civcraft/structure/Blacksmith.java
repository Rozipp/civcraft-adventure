...
public class Blacksmith extends Structure {
	...
	public void saveCatalyst(CraftableCustomMaterial craftMat, String key) {
	...
	public void deposit_forge(Player player) throws CivException {
		...
		if (sessions == null || sessions.size() == 0) {
			...
			CraftableCustomMaterial craftMat = CraftableCustomMaterial.getCraftableCustomMaterial(sessions.get(0).value);
			if (craftMat == null) {
	...
	public void perform_forge(Player player, double cost) throws CivException {
		...
		if (freeStr == null) {
			...
			CraftableCustomMaterial craftMat = CraftableCustomMaterial.getCraftableCustomMaterial(mid);
			if (craftMat == null) {
				throw new CivException(CivSettings.localize.localizedString("blacksmith_forge_missingCatalyst"));
			}
