...
public class FishHatchery extends Structure {
	...
	class FisheryAsyncTask extends CivAsyncTask {
		...
		private int getBiome() {
			...
			if (biome.equals(Biome.BIRCH_FOREST_HILLS) || biome.equals(Biome.MUTATED_BIRCH_FOREST) || biome.equals(Biome.MUTATED_BIRCH_FOREST_HILLS) || biome.equals(Biome.MUTATED_TAIGA_COLD) || biome.equals(Biome.MUTATED_EXTREME_HILLS)
					|| biome.equals(Biome.MUTATED_EXTREME_HILLS_WITH_TREES) || biome.equals(Biome.ICE_MOUNTAINS) || biome.equals(Biome.MUTATED_JUNGLE_EDGE) || biome.equals(Biome.JUNGLE_HILLS) || biome.equals(Biome.MUTATED_JUNGLE)
					|| biome.equals(Biome.MUTATED_MESA) || biome.equals(Biome.MUTATED_MESA_CLEAR_ROCK) || biome.equals(Biome.MUTATED_MESA_CLEAR_ROCK) || biome.equals(Biome.MUTATED_MESA_ROCK) || biome.equals(Biome.MUTATED_SAVANNA)
					|| biome.equals(Biome.MUTATED_SAVANNA_ROCK) || biome.equals(Biome.SMALLER_EXTREME_HILLS) || biome.equals(Biome.MUTATED_SWAMPLAND) || biome.equals(Biome.MUTATED_TAIGA)) {
				return 1;
			} else if (biome.equals(Biome.BIRCH_FOREST) || biome.equals(Biome.EXTREME_HILLS) || biome.equals(Biome.FOREST) || biome.equals(Biome.FOREST_HILLS) || biome.equals(Biome.ICE_FLATS) || biome.equals(Biome.ICE_MOUNTAINS)
					|| biome.equals(Biome.MUTATED_ICE_FLATS) || biome.equals(Biome.JUNGLE) || biome.equals(Biome.JUNGLE_EDGE) || biome.equals(Biome.MUTATED_REDWOOD_TAIGA) || biome.equals(Biome.MUTATED_REDWOOD_TAIGA_HILLS)
					|| biome.equals(Biome.REDWOOD_TAIGA) || biome.equals(Biome.REDWOOD_TAIGA_HILLS) || biome.equals(Biome.ROOFED_FOREST) || biome.equals(Biome.MESA) || biome.equals(Biome.MESA_CLEAR_ROCK) || biome.equals(Biome.MESA_ROCK)
					|| biome.equals(Biome.EXTREME_HILLS_WITH_TREES) || biome.equals(Biome.ROOFED_FOREST) || biome.equals(Biome.SAVANNA) || biome.equals(Biome.SAVANNA_ROCK) || biome.equals(Biome.TAIGA) || biome.equals(Biome.TAIGA_HILLS)) {
						return 2;
					} else
				if (biome.equals(Biome.BEACHES) || biome.equals(Biome.COLD_BEACH) || biome.equals(Biome.TAIGA_COLD) || biome.equals(Biome.DEEP_OCEAN) || biome.equals(Biome.DESERT) || biome.equals(Biome.DESERT_HILLS)
						|| biome.equals(Biome.MUTATED_DESERT) || biome.equals(Biome.FROZEN_OCEAN) || biome.equals(Biome.FROZEN_RIVER) || biome.equals(Biome.MUSHROOM_ISLAND) || biome.equals(Biome.MUSHROOM_ISLAND_SHORE)
						|| biome.equals(Biome.OCEAN) || biome.equals(Biome.PLAINS) || biome.equals(Biome.RIVER) || biome.equals(Biome.STONE_BEACH) || biome.equals(Biome.SWAMPLAND)) {
							return 3;
						} else {
							return 0;
						}
		...
		private ItemStack getFishForBiome() {
			...
			if (newItem == null) newItem = CustomMaterial.spawn(CustomMaterial.getCustomMaterial("mat_fish_fish"));
