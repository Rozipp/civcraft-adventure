...
public class TeleportPlayerTaskTown extends BukkitRunnable {
	...
	public TeleportPlayerTaskTown(final Resident resident, final Location location, final Town town) {
	...
	public void run() {
		...
		CivLog.info("\u0422\u0435\u043b\u0435\u043f\u043e\u0440\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 \u0438\u0433\u0440\u043e\u043a\u0430 " + this.resident.getName() + " \u0432 \u0433\u043e\u0440\u043e\u0434 "
				+ this.town.getName());
		try {
			int i = 10;
			while (i >= 0) {
				...
				if (!this.resident.getTreasury().hasEnough(5000.0)) {
					CivMessage.sendError(this.resident, CivSettings.localize.localizedString("var_teleport_notEnoughMoney", "§a" + (5000 - (int) this.resident.getTreasury().getBalance()) + "§c",
							"§c" + CivMessage.plurals(5000 - (int) this.resident.getTreasury().getBalance(), "\u043c\u043e\u043d\u0435\u0442\u0430", "\u043c\u043e\u043d\u0435\u0442\u044b", "\u043c\u043e\u043d\u0435\u0442")));
					return;
				}
				if (i != 0) {
					CivMessage.sendSuccess(this.resident, CivSettings.localize.localizedString("cmd_camp_teleport_waiting", "§c" + i + "§a",
							"§6" + CivMessage.plurals(i, "\u0441\u0435\u043a\u0443\u043d\u0434\u0443", "\u0441\u0435\u043a\u0443\u043d\u0434\u044b", "\u0441\u0435\u043a\u0443\u043d\u0434")));
					CivSettings.localize.localizedString("cmd_camp_teleport_waiting", CivColor.RoseBold + i + CivColor.LightGreenBold,
							CivColor.GoldBold + CivMessage.plurals(i, "\u0441\u0435\u043a\u0443\u043d\u0434\u0443", "\u0441\u0435\u043a\u0443\u043d\u0434\u044b", "c\u0435\u043a\u0443\u043d\u0434"));
				} else {
					if (!this.resident.getTreasury().hasEnough(5000.0)) {
						CivMessage.sendError(this.resident, CivSettings.localize.localizedString("var_teleport_notEnoughMoney", "§a" + (5000 - (int) this.resident.getTreasury().getBalance()) + "§c",
								"§c" + CivMessage.plurals(5000 - (int) this.resident.getTreasury().getBalance(), "\u043c\u043e\u043d\u0435\u0442\u0430", "\u043c\u043e\u043d\u0435\u0442\u044b", "\u043c\u043e\u043d\u0435\u0442")));
		...
		Bukkit.getServer().getScheduler().scheduleSyncDelayedTask((Plugin) CivCraft.getPlugin(), () -> {
			try {
				CivGlobal.getPlayer(resident).teleport(this.location);
				this.resident.isTeleporting = false;
			} catch (CivException e) {
				CivLog.error("TeleportPlayerTaskTown:" + e.getMessage());
			}
		});
	}
}
