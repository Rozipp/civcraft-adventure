...
public class PlayerProximityComponentTimer implements Runnable {
	...
	@Override
	public void run() {
		/* Grab all of the player proximity components and update them, this task runs asynchronously once per tick and gathers all of the player
		 * locations into an async friendly data-structure. */
