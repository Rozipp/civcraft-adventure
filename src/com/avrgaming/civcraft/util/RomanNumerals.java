...
/** EnchantmentAPI © 2017 com.sucy.enchant.util.RomanNumerals */
public class RomanNumerals {
	...
	private static final Map<Character, Integer> CHAR_TO_NUMBER = Arrays.stream(RomanNumber.values()).filter(num -> num.name().length() == 1).collect(ImmutableMap.toImmutableMap(num -> num.name().charAt(0), RomanNumber::getValue));
}
