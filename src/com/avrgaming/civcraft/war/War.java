...
public class War {
	...
	/* When a civ conqueres a town, then has its capitol conquered, the town that it just conquered needs to go to the new owner. If the new
	 * owner was the town's old owner, then that town is no longer defeated. */
	...
	/* The 'claimed' flag is used to tag towns that had illegal town hall placements, and have already been claimed. When war time starts, we
	 * should reset the claim flag so it can be claimed by someone else. */
