        ...
        for (final Player joinedPlayer : joinedPlayers) {
            ...
            if (!joinedPlayer.isOp()) {
                if (!PermissionGroup.hasGroup("Helper", joinedPlayer.getName())) {
                    if (resident == null) {
                        TaskMaster.syncTask(new PlayerKickBan(joinedPlayer.getName(), true, false, "§c\u0412\u044b \u0431\u044b\u043b\u0438 \u043a\u0438\u043a\u043d\u0443\u0442\u044b, \u0438\u0431\u043e \u0432\u044b \u043d\u0435 \u0440\u0435\u0437\u0438\u0434\u0435\u043d\u0442?!"));
                    }
                    else if (resident.getCiv() == null) {
                    ...
                    else if (!resident.getCiv().getDiplomacyManager().isAtWar()) {
