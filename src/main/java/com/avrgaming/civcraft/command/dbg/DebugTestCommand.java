...
public class DebugTestCommand extends MenuAbstractCommand {
	...
	public DebugTestCommand(String perentCommand) {
		...
		add(new CustomCommand("test").withDescription("test").withExecutor(new CustomExecutor() {
			@Override
			public void run(CommandSender sender, Command cmd, String label, String[] args) throws CivException {
				Player player =Commander.getPlayer(sender);
				Location location = player.getLocation();
				CivMessage.send(sender, "location : " + location);
				CivMessage.send(sender, "getDirection : " + location.getDirection());
				CivMessage.send(sender, "dir : " + Direction.newDirection(location));
			}
		}));
