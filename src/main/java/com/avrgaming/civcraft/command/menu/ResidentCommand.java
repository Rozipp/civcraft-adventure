...
public class ResidentCommand extends MenuAbstractCommand {
	...
	public ResidentCommand(String perentComman) {
		...
		add(new CustomCommand("com/avrgaming/pvptimer").withDescription(CivSettings.localize.localizedString("cmd_res_pvptimerDesc")).withExecutor(new CustomExecutor() {
			@Override
			public void run(CommandSender sender, Command cmd, String label, String[] args) throws CivException {
				Resident resident = Commander.getResident(sender);
