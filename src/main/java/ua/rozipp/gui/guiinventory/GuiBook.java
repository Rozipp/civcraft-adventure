...
public class GuiBook extends GuiInventory {
	...
	public GuiBook(Player player, String arg) throws CivException {
		...
		this.addGuiItem(4, GuiItem.newGuiItem()//
		...
		this.addGuiItem(5, GuiItem.newGuiItem()//
		...
		this.addGuiItem(17, GuiItem.newGuiItem()//
		...
		this.addGuiItem(18, GuiItem.newGuiItem()//
		...
		this.addGuiItem(19, GuiItem.newGuiItem()//
		...
		this.addGuiItem(26, GuiItem.newGuiItem()//
